...
# Read single-nuclei data from sample CD36
sc <- Read10X(data.dir = "CLCD36HF1/")
...
seurat_object <- CreateSeuratObject(counts = sc, project = "CLCD36HF1", min.cells = 3, min.features = 200)
dim(seurat_object)
...
ggsave(path = "../results/CLCD36HF1/", filename = "CLCD36HF1_QC_Violin1.png", height = 10, width = 13, units = "in", dpi = 300)
plot1 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "percent.mt")
plot2 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
QC_FeaturePlot <- plot1 + plot2
ggsave(path = "../results/CLCD36HF1/", filename = "CLCD36HF1_QC_Feature_plot.png", height = 10, width = 13, units = "in", dpi = 300)


## We can hence remove those cells with lower than 200 genes, higher than some total of 3200 UMIs and 
...
png('../results/CLCD36HF1/CLCD36HF1_PCA_heatmap.png', width = 15, height = 15, units = "in", res = 300)
...
ggsave('../results/CLCD36HF1/elbow_plot.png', height = 15, 
...
ggsave(filename = "CLCD36HF1_tsne01.png",path = "../results/CLCD36HF1/",width = 15, height = 15, units = "in")
...
ggsave(filename = "CLCD36HF1_umap01.png",path = "../results/CLCD36HF1/",width = 15, height = 15, units = "in")
...
g1 + g2 + g3 + g4 + g5
ggsave(filename = "CLCD36HF1_umap_resolutions.png", path = "../results/CLCD36HF1/", height = 15, 
       width = 15, dpi = 300, units = "in")
...
saveRDS(object = seurat_object,file = '../results/CLCD36HF1/CLCD36HF1_Seuratv4.rds')
