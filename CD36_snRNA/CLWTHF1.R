...
# Read single-nuclei data from sample WT-1
sc <- Read10X(data.dir = "CLWTHF1/")
...
seurat_object <- CreateSeuratObject(counts = sc, project = "CLWTHF1", min.cells = 3, min.features = 200)
dim(seurat_object)
...
ggsave(path = "../results/CLWTHF1/", filename = "CLWTHF1_QC_Violin1.png", height = 10, width = 13, units = "in", dpi = 300)
plot1 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "percent.mt")
plot2 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
QC_FeaturePlot <- plot1 + plot2
ggsave(path = "../results/CLWTHF1/", filename = "CLWTHF1_QC_Feature_plot.png", height = 10, width = 13, units = "in", dpi = 300)
...
png('../results/CLWTHF1/CLWTHF1_PCA_heatmap.png', width = 15, height = 15, units = "in", res = 300)
...
ggsave('../results/CLWTHF1/elbow_plot.png', height = 15, 
...
ggsave(filename = "CLWTHF1_tsne01.png",path = "../results/CLWTHF1/",width = 15, height = 15, units = "in")
...
ggsave(filename = "CLWTHF1_umap01.png",path = "../results/CLWTHF1/",width = 15, height = 15, units = "in")
...
g1 + g2 + g3 + g4 + g5
ggsave(filename = "CLWTHF1_umap_resolutions.png", path = "../results/CLWTHF1/", height = 15, 
       width = 15, dpi = 300, units = "in")
...
saveRDS(object = seurat_object,file = '../results/CLWTHF1/CLWTHF1_Seuratv4.rds')
