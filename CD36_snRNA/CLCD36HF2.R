...
# Read single-nuclei data from sample MKK3/6-1
sc <- Read10X(data.dir = "CLCD36HF2/")
...
seurat_object <- CreateSeuratObject(counts = sc, project = "CLCD36HF2", min.cells = 3, min.features = 200)
dim(seurat_object)
...
ggsave(path = "../results/CLCD36HF2/", filename = "CLCD36HF2_QC_Violin1.png", height = 10, width = 13, units = "in", dpi = 300)
plot1 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "percent.mt")
plot2 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
QC_FeaturePlot <- plot1 + plot2
ggsave(path = "../results/CLCD36HF2/", filename = "CLCD36HF2_QC_Feature_plot.png", height = 10, width = 13, units = "in", dpi = 300)
...
seurat_object <- subset(seurat_object, subset = nFeature_RNA > 200 & nFeature_RNA < 3200 & percent.mt < 10)
seurat_object
...
png('../results/CLCD36HF2/CLCD36HF2_PCA_heatmap.png', width = 15, height = 15, units = "in", res = 300)
...
ggsave('../results/CLCD36HF2/elbow_plot.png', height = 15, 
...
ggsave(filename = "CLCD36HF2_tsne01.png",path = "../results/CLCD36HF2/",width = 15, height = 15, units = "in")
...
ggsave(filename = "CLCD36HF2_umap01.png",path = "../results/CLCD36HF2/",width = 15, height = 15, units = "in")
...
g1 + g2 + g3 + g4 + g5
ggsave(filename = "CLCD36HF2_umap_resolutions.png", path = "../results/CLCD36HF2/", height = 15, 
       width = 15, dpi = 300, units = "in")
...
saveRDS(object = seurat_object,file = '../results/CLCD36HF2/CLCD36HF2_Seuratv4.rds')
