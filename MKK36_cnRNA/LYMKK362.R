...
# We set our working directory wherever we want
setwd("../Desktop/TFM/snRNAseq/LYMKK361/After_Force_cells/code")

# Read single-nuclei data from sample MKK3/6-2
sc <- Read10X(data.dir = "../Cellranger_Count/LYMKK362/")
...
seurat_object <- CreateSeuratObject(counts = sc, project = "LYMKK362", min.cells = 3, min.features = 200)
dim(seurat_object)
...
ggsave(path = "../results/LYMKK362/", filename = "LYMKK362_QC_Violin1.png", height = 10, width = 13, units = "in", dpi = 300)
plot1 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "percent.mt")
plot2 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
QC_FeaturePlot <- plot1 + plot2
ggsave(path = "../results/LYMKK362/", filename = "LYMKK362_QC_Feature_plot.png", height = 10, width = 13, units = "in", dpi = 300)


## We can hence remove those cells with lower than 100 genes, higher than some total of 5500 UMIs and 
## those cells with higher than total MT percentage of 5. We use the subset function to delete those cells 
## with those extreme properties.
seurat_object <- subset(seurat_object, subset = nFeature_RNA > 200 & nFeature_RNA < 2500 & percent.mt < 30)
seurat_object
...
png('../results/LYMKK362/LYMKK362_PCA_heatmap.png', width = 15, height = 15, units = "in", res = 300)
...
ggsave('../results/LYMKK362/elbow_plot.png', height = 15, 
...
ggsave(filename = "LYMKK362_tsne01.png",path = "../results/LYMKK362/",width = 15, height = 15, units = "in")
...
ggsave(filename = "LYMKK362_umap01.png",path = "../results/LYMKK362/",width = 15, height = 15, units = "in")
...
g1 + g2 + g3 + g4 + g5
ggsave(filename = "LYMKK362_umap_resolutions.png", path = "../results/LYMKK362/", height = 15, 
       width = 15, dpi = 300, units = "in")

## The number of cluster to use will depend on your analysis. In our case resolution of 0.5 fitted correctly

Idents(seurat_object) <- "RNA_snn_res.0.5"


## 5.6. Save the Seurat Object

saveRDS(object = seurat_object,file = '../results/LYMKK362/LYMKK362_Seuratv4.rds')
