...
sc <- Read10X(data.dir = "../Cellranger_Count/LYWT1/")
...
seurat_object <- CreateSeuratObject(counts = sc, project = "LYWT1", min.cells = 3, min.features = 200)
dim(seurat_object)
...
ggsave(path = "../results/LYWT1/", filename = "LYWT1_QC_Violin1.png", height = 10, width = 13, units = "in", dpi = 300)
plot1 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "percent.mt")
plot2 <- FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
QC_FeaturePlot <- plot1 + plot2
ggsave(path = "../results/LYWT1/", filename = "LYWT1_QC_Feature_plot.png", height = 10, width = 13, units = "in", dpi = 300)
...
seurat_object <- subset(seurat_object, subset = nFeature_RNA > 200 & nFeature_RNA < 3000 & percent.mt < 25)
seurat_object
...
png('../results/LYWT1/LYWT1_PCA_heatmap.png', width = 15, height = 15, units = "in", res = 300)
DimHeatmap(seurat_object, dims = 1:15, cells = 500, balanced = TRUE)
dev.off()
...
ggsave('../results/LYWT1/elbow_plot.png', height = 15, 
...
ggsave(filename = "LYWT1_tsne01.png",path = "../results/LYWT1/",width = 15, height = 15, units = "in")
...
ggsave(filename = "LYWT1_umap01.png",path = "../results/LYWT1/",width = 15, height = 15, units = "in")
...
g1 + g2 + g3 + g4 + g5
ggsave(filename = "LYWT1_umap_resolutions.png", path = "../results/LYWT1/", height = 15, 
       width = 15, dpi = 300, units = "in")
...
saveRDS(object = seurat_object,file = '../results/LYWT1/LYWT1_Seuratv4.rds')
